    ...
    <div className="font-NTR flex flex-col">
      ...
      <nav className="sticky top-0 z-50 text-gray-200  bg-indigo-400 py-2">
        <div className="flex justify-center px-7 lg:px-40 md:px-20 sm:px-10">
          ...
          <a
            href="#"
            className="hover:text-white text-lg font-bold w-[97%] xl:w-[20%] lg:w-[20%] md:w-[20%] "
          >
            Helia Haghighi
          </a>
      ...
      >
        <div className="flex flex-row text-4xl xl:text-7xl sm:text-5xl ">
          <p className="text-gray-200">
            <b className="text-indigo-400">Helia</b> here.
          </p>
          <p className="rounded ml-1 text-indigo-400 blink">|</p>
        </div>
        <span className="text-xl text-gray-400 mb-4 xl:text-4xl sm:text-2xl">
          Driven by challenges, fueled by learning
        </span>
        <span className="text-m sm:text-xl text-justify xl:w-[70%] md:w-[90%] text-gray-400 mb-7">
      ...
      {/* ABOUT ME */}
      <div id="about" className="p-7 lg:p-40 md:p-20 sm:p-10">
        ...
        <div className="mt-12 text-gray-400 xl:flex xl:flex-row xl:items-center lg:items-start flex flex-col-reverse">
          <div className="xl:mr-6 text-justify text-m sm:text-xl">
            <p className="mb-5">
              ...
              . Beyond my academic pursuits, I actively engage in coding
              competitions and work on personal projects, continuously seeking
              challenges to refine my skills.
            </p>
            <p className="mb-5">
            ...
            >
              ...
              <ul className=" text-xs 2xl:w-[80%] sm:text-xs md:text-lg">
                <li className="flex flex-row my-5 text-justify">
                  ...
                  <p>
                    I had the great opportunity to develop my skills in Robotic
                    Process Automation (RPA) through Microsoft Power Automate.
                    By automating repetitive tasks, I was able to decrease
                    workload, boost productivity and efficiency for the business
                    team.
                  </p>
                </li>
                <li className="flex flex-row mt-5 text-justify">
                  <p className="text-indigo-400 mr-5">▹</p>
                  <p>
                    This position required a thorough comprehension of business
                    workflows, which I achieved through consistent communication
                    and collaboration with the team. I made sure that the
                    automations fit seamlessly into their current processes.
                  </p>
                </li>
              </ul>
            </div>
        ...
        <div className="w-full h-full grid lg:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          <div className="card p-8">
            ...
            <div className="flex flex-col justify-between h-full">
              ...
              <span className="mt-[11%]">React, TailwindCSS, JavaScript</span>
            </div>
          </div>
          <div className="card p-8">
            <div className="flex flex-row justify-between items-center w-full mb-2">
            ...
            <div className="flex flex-col justify-between h-full">
              <span>
                A resume template website styled with vanil className=""la CSS.
              </span>
